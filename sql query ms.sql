...
-- Q5 How many customers are there from each country?
...
--  Q6: Who is the senior most employee , return (first_name) and (last_name) as full name  based on job title? 
...
-- Q9 Which invoice had the highest total amount?
...
-- 10 Find the average amount spent per invoice for each customer.
...
-- 11 Find the top 3 employees who have processed the most sales (total invoice amount).
...
-- 12 Find the total sales for each artist.
...
-- 13 Which country has the highest average invoice total?
...
-- 14 Return the customers who made more than 5 purchases and have spent more than the average amount across all customers.
...
/* Q15: Which city has the best customers? We would like to throw a promotional Music Festival in the city we made the most money. 
...
-- Q.16 What is the average length of tracks in each genre?
...
/* Q17 Who is the best customer? The customer who has spent the most money will be declared the best customer. 
...
/* Q18 Write query to return the email, first name, last name, & Genre of all Rock Music listeners. 
...
/* Q19 Let's invite the artists who have written the most rock music in our dataset. 
...
/* Q20 Return all the track names that have a song length longer than the average song length. 
...
/* Q21 Find how much amount spent by each customer on artists? Write a query to return customer name, artist name and total spent */
...
/* Q22 We want to find out the most popular music Genre for each country. We determine the most popular genre as the genre 
...
/* Q23 Write a query that determines the customer that has spent the most on music for each country. 
